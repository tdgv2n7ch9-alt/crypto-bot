...
CEX_DEPOSIT_ADDRESSES = {
    ...
    # Найдены живьём 2026-07-17 (P1, ретроспективный BANK-скан): реальные
    # адреса из живых данных сегодняшнего дня, каждый подтверждён отдельным
    # web-поиском BscScan-тега.
    "0x0d0707963952f2fba59dd06f2b425ace40b492fe": "Gate 1 (Gate.io deposit)",  # получил
    # 22.25M BANK (~$1.9M) от 46 разных адресов в узком окне блоков
    # 110488393-110488633 сегодня -- см. PROGRESS.md, скорее всего сам
    # разлок->биржа
    "0x8894e0a0c962cb723c1976a4421c95949be2d4e3": "Binance 51",  # получил 6M BANK
    # напрямую от уже известного 0xf977814e (Binance: Hot Wallet 20) --
    # внутреннее движение Binance, не "депозит" от внешней стороны, но сам
    # адрес подтверждён как биржевой
}
