...
def test_options_auto_shadow_enabled_after_phase_b_go_is_true():
    """Владелец, ДА 2026-07-18 (после #290-critical -- get_options_data
    живой): флаг переведён False->True, см. PROGRESS.md очередь п.2."""
    assert se.OPTIONS_AUTO_SHADOW_ENABLED is True
